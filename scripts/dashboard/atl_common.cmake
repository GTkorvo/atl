...
#   include(${CTEST_SCRIPT_DIRECTORY}/atl_common.cmake)
#
...
#   dashboard_source_name     = Name of source directory (atl)
#   dashboard_binary_name     = Name of binary directory (atl-build)
...
set(CTEST_PROJECT_NAME "ATL")
set(CTEST_DROP_SITE "open.cdash.org")
if(NOT dashboard_git_url)
  set(dashboard_git_url "https://github.com/GTkorvo/atl.git")
endif()
...
if(NOT dashboard_source_name)
  set(dashboard_source_name "atl")
endif()
if(NOT dashboard_model)
  set(dashboard_model Experimental)
endif()

# Disable submissions since no dashboard exists
